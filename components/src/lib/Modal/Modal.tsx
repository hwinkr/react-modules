...
import { DEVICE_WIDTH, MODAL_BORDER, MODAL_POSITION } from "../constants/modal";
...
const Modal = ({ children, isOpen, position = "center", device = "mobile", onClose }: ModalProps) => {
...
const StyledModal = styled.section<{ $position: ModalPosition; $device: Device }>`
  ...
  & > div:nth-child(2) {
    border-radius: ${({ $position }) => MODAL_BORDER[$position]};
  }
`;
